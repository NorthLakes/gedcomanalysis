...
public class ListSourActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.list_sources);
    }
    ...
    public void onStart() {
		...
		// Add a fragment
		ListSourFragment myFragment = new ListSourFragment();
		fragmentTransaction.replace(R.id.listsourfragment, myFragment);
		// fragmentTransaction.addToBackStack(null);
		fragmentTransaction.commit();		
    }
