...
public class ListFamlActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.list_families);
    }
    ...
    public void onStart() {
		...
		// Add a fragment
		ListFamlFragment myFragment = new ListFamlFragment();
		fragmentTransaction.replace(R.id.listfamlfragment, myFragment);
		// fragmentTransaction.addToBackStack(null);
		fragmentTransaction.commit();		
    }
